...
export function SynapsesCanvas({
  ...
  }, [currentTime, collapseEmptySpace, totalDuration, totalPackedDuration, activeSceneId, scenes])
  ...
  const handleCanvasClick = (e: React.MouseEvent<HTMLCanvasElement>) => {
    ...
    if (minDiff < 40) {
      ...
      setCurrentTime(collapseEmptySpace ? packedStarts[targetScene.start] : targetScene.start)
    }
  }
  ...
  return (
    <div className={styles.canvasWrapper}>
      ...
      <div className={styles.canvasLegend}>
        <span>⬤ синапс (пересечение линий судеб персонажей) · кликни на синапс для перехода</span>
      </div>
    </div>
  )
}
