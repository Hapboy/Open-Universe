...
// NarrativeSettings, Preset, MediaAsset, AiJob entities already exist (see
// their respective folders) but aren't registered here yet - tables are
// being connected one at a time, in build-priority order, rather than all at
// once. Add each to this list (and to app.module.ts's
